  ...
  wolftrap: {
    name: 'Wolf Trap',
    state: 'VA',
    center: { lat: 38.9378, lng: -77.2634 },
    zoom: 15,
    dataFile: './data/wolf-trap-va-poi.json',
    supplementalPoiFile: './regions/wolf-trap-va/wolf-trap-va-poi.json',
    civicFile: './regions/wolf-trap-va/civic/index.json', weatherFile: './regions/wolf-trap-va/weather.json'
  },
  pgcounty: {
  ...
  dc: {
    ...
    supplementalPoiFile: './regions/washington-dc/washington-dc-poi.json', weatherFile: './regions/washington-dc/weather.json'
  },
  sedona: {
    name: 'Sedona',
    state: 'AZ',
